<table class="table">
    ...
    <tr>
        <td>{{ $item->id}}<input type="text" id="id{{$item->id}}" value="{{ $item->id}}" hidden></td>
        <td >{{ $item->kd_barang }}<input type="text" id="kdbrg{{$item->id}}" value="{{ $item->kd_barang}}" hidden> </td>
        <td >{{ $item->nm_barang }}<input type="text" id="nmbrg{{$item->id}}" value="{{ $item->nm_barang}}" hidden></td>
        <td >{{ $item->jumlah }}<input type="text" id="jml{{$item->id}}" value="{{ $item->jumlah}}" hidden></td>
