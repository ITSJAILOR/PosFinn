...
<button class="NavButton" onclick="window.location.href='/transaksi'">Orders</button>
<button class="NavButton" onclick="window.location.href='/persediaan'">Inventory</button>
<button class="NavButton" onclick="window.location.href='/pengeluaran'">Pengeluaran</button>
